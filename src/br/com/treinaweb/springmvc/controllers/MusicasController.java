...
import br.com.treinaweb.spirngmvc.repositories.RepositorioAlbum;
import br.com.treinaweb.spirngmvc.repositories.RepositorioMusica;
...
public class MusicasController {
	...
	public String alterar(@PathVariable("id") Long id, Model model) {
		Musica musicaAlterada = repositorioMusica.findOne(id);
